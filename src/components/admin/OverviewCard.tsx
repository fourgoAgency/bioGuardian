...
export default function OverviewCard({ title, Icon, value, timeframe }: { title: string; Icon: React.ComponentType<React.SVGProps<SVGSVGElement>>; value: string; timeframe: string }) {
  return (
