                        ...
                        <Card className="border-none shadow-none bg-transparent">
                            <CardContent className={`relative flex items-center justify-center p-8 md:p-12 aspect-[16/7] rounded-2xl overflow-hidden bg-gradient-to-br ${product.color}`}>
                                <div className="grid md:grid-cols-2 gap-8 items-center w-full text-white">
                                    ...
                                    <div className="relative h-full md:h-auto md:self-stretch">
                                        <Image src={product.mainImage} alt={product.name} width={1000} height={1000} className="w-full h-full object-contain drop-shadow-2xl transition-transform duration-500 hover:scale-105"/>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
